...
*SharePoint 2016 Preview Update*
...
Let's get one thing straight.  These scripts are not designed to be used as production quality installation/deployment scripts for SharePoint 2016.  They are intended to be educational.

Sure, they will work nicely to build out demo (or even test) environments, but if you want scalable, predictable, repeatable deployment of SharePoint 2016, please look to AutoSPInstaller (http://autospinstaller.codeplex.com).
...
I know you know this, but I will say it anyway.  There are many ways to skin the SharePoint installation and PowerShell cat.  
...
The principal purpose of these scripts is to show you fundamental PowerShell concepts and constructs.  I find that when I am stretching my legs with a new technology, real-world context helps me so wrapping the PowerShell concepts in a real-world example of deploying a SharePoint 2016 farm seemed like a good idea.  Although purposed to SharePoint, this set of scripts is not uniquely aimed at SharePoint people (although it originally was) it's just trying to create something real and educational as opposed to being abstract.
...
Firstly, for those new to PowerShell, jumping over all the basics straight to understanding functions is a leap and a half and goes against the ethos of this script suite.  Secondly, the first version of this set of scripts was shown as part of a webinar series that referenced the numbered individual scripts and a number of people still use these scripts in that context.  In a later revision, I fully intend (*ahem*) to provide a version of this script set deployable as a module, largely to show how script modules work :)
...
A final thanks goes to Don Jones.  He's been at the heart of the PowerShell community since forever and he is (I believe) in some way omnipresent across the intertubes so if I don't thank him he will somehow find out and I'll be blacklisted :) Don't believe me?  Just search for *anything* including the word "PowerShell" and you will get a return from something he has created, he's everywhere.
